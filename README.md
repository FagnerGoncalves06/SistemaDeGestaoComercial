...
Depois de criar um repositório vazio no GitHub, substitua o endereço e execute:

```powershell
git remote add origin https://github.com/SEU_USUARIO/SistemaDeGestaoComercial.git
git branch -M main
git push -u origin main
```

Não inclua `.env`, senhas ou connection strings privadas. Após publicar, você pode adicionar ao README o badge do workflow usando a URL definitiva do repositório.
